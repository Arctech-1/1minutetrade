...
<div class="w-full max-w-md">
    ...
    <form action="{{ route('withdraw.submit') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
      ...
      <div class="mb-6">
        ...
        <input class=" form-input shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" type="number" id="amount" name="amount" step=".01" min="1" max="{{Auth::user()->account_balance}}" placeholder="" >
